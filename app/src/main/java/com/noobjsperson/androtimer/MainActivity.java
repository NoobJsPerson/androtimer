...
public class MainActivity extends Activity
{
    ...
    public void updateTotalTime(){
        ...
        String modmsg = "Mod Message: time starts at "+formatTime(start)+" and ends at "+formatTime(end)+" with a framerate of "+frameRate+" fps to get a final time of "+formatted;
        fw.setText(modmsg);
    }
